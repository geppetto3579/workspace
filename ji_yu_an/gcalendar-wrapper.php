 ...
 */
$calColorBgDark      = '#d19389';	// dark background color
$calColorTextOnDark  = '#4d241e';	// text appearing on top of dark bg color
$calColorBgLight     = '#e0b8b1';	// light background color
$calColorTextOnLight = '#4d241e';	// text appearing on top of light bg color
$calColorBgToday     = '#FDE4DD';	// background color for "today" box
